...
%%
[fitresult, gof] = createFit1(abundance_gap(1:48), potato_intensity_mean(1:48)); 
...
function [fitresult, gof] = createFit1(x, y)
    ...
    legend(h, 'abundance v. potato intensity', 'polynomial fit', 'Location', 'NorthEast', 'Interpreter', 'none');
